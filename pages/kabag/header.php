  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="glyphicon glyphicon-tags"></i> <span>Memo</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="index.php?hal=mmo"><i class="fa fa-circle-o"></i> Data Memo</a></li>
            <li><a href="index.php?hal=mb"><i class="fa fa-circle-o"></i> Buat Memo</a></li>
          </ul>
        </li>
